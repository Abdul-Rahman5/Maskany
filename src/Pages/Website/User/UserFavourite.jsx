                    ...
                    <div className="favUserSide">
                      <div className="favUserDetails">
                        ...
                        <div className="favBtnSettings">
                          ...
                          {/* <div className="share">
                            <FaShareAlt />
                            <FacebookShareCount url={`http://localhost:3000/favourites`} />sf
                            مشاركة
                            <FacebookShareCount url={`http://localhost:3000/favourites`}>
  {shareCount => <span className="myShareCountWrapper">{shareCount}dd</span>}
</FacebookShareCount>
                          </div> */}
                        </div>
                      </div>
