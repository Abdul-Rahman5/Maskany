...
export default function Map() {
  ...
  const [markerSpaceColor, setMarkerSpaceColor] = useState("black");
    // Event handler for markerSpace div click
    const handleMarkerSpaceClick = () => {
      setMarkerSpaceColor(markerSpaceColor === "black" ? "red" : "black");
    };
  ...
  useEffect(() => {
    ...
    filteredData().forEach((markerData) => {
      ...
      const infowindow = new window.google.maps.InfoWindow({
        content: ` <p   className="markerPrice  2">${formatPrice(
          markerData.price
        )}</p> `,
