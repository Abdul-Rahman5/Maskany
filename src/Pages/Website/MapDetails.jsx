...
import homeImg from "../../Assets/Images/NoPath - Copy (39).png";
export default function MapDetails() {
        ...
        .then((res) => {
          ...
          if (updatedMarker.infoWindow) {
            updatedMarker.infoWindow.setContent(
              `<p className="markerPrice overflow-visible p-3 1" style="color: red !important;">${formatPrice(
                updatedMarker.title
              )}</p>`
            );
  ...
  useEffect(() => {
    ...
    filteredData().forEach((markerData) => {
      ...
      const infowindow = new window.google.maps.InfoWindow({
        content: `<p className="markerPrice overflow-visible p-3 2">${formatPrice(
          markerData.price
        )}</p>`,
        ...
        if (marker.infoWindow) {
          if (marker.is_seen === true) {
            marker.infoWindow.setOptions({
              content: `<p className="markerPrice overflow-visible p-3 3" style="color: red !important;">${formatPrice(
                marker.title
              )}</p>`,
              backgroundColor: "#fff",
              borderColor: "#00ff00",
            ...
            marker.infoWindow.setOptions({
              content: `<p className="markerPrice overflow-visible p-3 4">${formatPrice(
                marker.title
              )}</p>`,
              backgroundColor: "#fff",
              borderColor: "#000",
  ...
  return (
    <>
      <div className="layere">
        <div className="item">
          <div className="row">
            <div className="col-md-1"></div>
            <div className="col-md-9 bg-body d-flex align-item-center justify-content-center mt-5   rounded-3">
              <div className="row shadow-lg my-5 m-auto w-75 rounded-3">
                <div className="col-md-9 p-4 ">
                  <h6 className="">فيلا للبيع في خميس مشيط</h6>
                  <div className="price d-flex ">
                    <p className="fontSM mx-2">560,000</p>
                    <p className="fontSM mx-2">جنية مصري</p>
                  </div>
                  <p className="fontSM ">
                    دبلكس. شرقي شمالي. بناء شخصي. ع اشراف هندسي. حجر ويوجود. شقة
                    مستقلة بدرج. خارجي. السعر الشارعين مليونين والبطن مليون و
                    850. تكييف مركزي كونسلد. موفر للكهرباء وحدات مساحات الغرف
                    ..واسعة وتشطيب راقي ويوجد موقع مصعد
                  </p>
                  <div className="icon fs-4 w-25 m-auto">
                    <div className="bottomSide boPlus">
                      <div className="markerSpace "> م² | </div>
                ...
                <div className="col-md-3 h-100 p-0">
                  <img className="w-100 h-100 " src={homeImg} alt="home" />
                </div>
              </div>
              <Link className="nav-link ms-3 mt-3 " to="/map">
                X
              </Link>
            </div>
            <div className="col-md-1"></div>
